...
func main() {
	...
	// 我们也可以编码 json 值到自定义类型。
	// 这个功能的好处就是可以为我们的程序带来额外的类型安全加强，
	// 并且消除在访问数据的类型断言。
	...
	// 在上面的例子中，我们经常使用 byte 和 string 作为使用标准输出时数据和 json 表示之间的值。
	// 我们也可以和 `os.Stdout` 一样，将 json 编码直接输出到 `os.Writer` 流中，或者作为 HTTP 响应体。
